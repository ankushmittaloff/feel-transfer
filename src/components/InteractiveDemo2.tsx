...
const HINT_DISMISSED_KEY_2 = "interactive-demo-2-hint-dismissed";
...
const InteractiveDemo2 = () => {
  ...
  const [hasInteracted, setHasInteracted] = useState(() => {
    if (typeof window !== "undefined") {
      return sessionStorage.getItem(HINT_DISMISSED_KEY_2) === "true";
    }
    return false;
  });
  ...
  const dismissHint = useCallback(() => {
    ...
    sessionStorage.setItem(HINT_DISMISSED_KEY_2, "true");
  ...
  return (
    <section id="interactive-demo-2" className="py-20 md:py-28 bg-muted/30">
